...
(function(factory) {
	...
	Plugin.prototype = {
		...
		_generateMarkup: function() {
			...
			// this._appendListItems(africaCodes, "");
   ...
   ********************/
    ...
    const continentCodes = {
        "Oceania": ["as", "au", "ck", "fj", "fm", "gu", "hm", "ki", "mh", "mp", "nc", "nf", "nr", "nz", "nu", "pf", "pg", "pn", "pw", "sb", "ws", "tv", "to", "vu", "wf"],
        "Europe": ["al", "ad", "at", "ax", "ba", "be", "bg", "by", "ch", "cy", "cz", "de", "dk", "ee", "es", "fi", "fo", "fr", "ge", "gg", "gi", "gr", "hr", "hu", "ie", "im", "is", "it", "je", "li", "lt", "lu", "lv", "mc", "md", "me", "mk", "mt", "nl", "no", "pl", "pt", "ro", "rs", "ru", "se", "si", "sk", "sm", "tr", "ua", "gb", "va", "xk"],
        "Asia": ["ae", "af", "am", "az", "bd", "bh", "bn", "bt", "cc", "cn", "cx", "ge", "hk", "il", "in", "io", "id", "ir", "iq", "jp", "jo", "kh", "kp", "kz", "kg", "kr", "kw", "la", "lb", "lk", "mm", "mn", "mo", "mv", "my", "np", "om", "pk", "ph", "ps", "qa", "sa", "sg", "sy", "tj", "th", "tl", "tm", "tw", "uz", "vn", "ye"],
        "Americas": ["ai", "ag", "ar", "aw", "bs", "bb", "bm", "bo", "bl", "br", "bz", "bq", "ca", "cl", "co", "cr", "cu", "cw", "dm", "do", "ec", "fk", "gd", "gf", "gl", "sv", "gt", "gp","gy", "ht", "hn", "jm", "kn", "ky", "lc", "mf", "mx", "mq", "ms", "ni", "pa", "pm", "pr", "py", "pe", "sr", "sx", "tc", "tt", "us", "uy", "ve", "vc", "vg"],
        "Africa": ["ao", "bj", "bw", "bf", "bi", "ci", "cm", "cv", "cf", "dz", "td", "km", "cg", "cd", "dj", "eg", "gq", "eh", "er", "et", "ga", "gm", "gh", "gn", "gw", "ke", "ls", "lr", "ly", "mg", "mw", "ml", "mr", "mu", "ma", "mz", "na", "ne", "ng", "re", "rw", "sh", "st", "sn", "sc", "sl", "so", "ss", "sd", "sz", "tz", "tg", "tn", "ug", "yt", "zm", "za", "zw"],    
    }
