...
(function(factory) {
	...
	Plugin.prototype = {
		...
		_appendListItems: function(countries, className) {
			...
			// for each country
			var continents = {"Asia": [], "Australia & Oceania": [], "Central America & Caribbean": [], "Europe": [], "MENA": [], "North America": [], "South America": [], "Sub-Saharan Africa": []};
            ...
            $.each(continents, function(continent, countryList) {
            ...
            var tmp = "";
            $.each(continents, function(continent, countryList) {
                // Add a 'blank' option for the continent
                tmp += '<li class="continent" data-continent="' + continent + '" style="text-align: center; margin: 5px 0 5px 0;">';
                tmp += '<span style="background-color: white; z-index: 1; padding: 0 10px 0 10px; position: relative;">' + continent + '</span>';
                tmp += '<hr style="border-top-color: black; margin: 0px; position: relative; top: -6px;" />';
                tmp += '</li>';
                ...
                if (continent === "Sub-Saharan Africa" || continent == "MENA" || continent == "Central America & Caribbean") {
                    tmp += '<li style="text-align: center; padding: 5px"> Future Work...</li>';
                }
            });
   ...
   ********************/
    ...
    const continentCodes = {
        ...
        "Asia": ['bd', 'bt', 'bn', 'kh', 'cn', 'in', 'id', 'jp', 'kz', 'kp', 'kr', 'kg', 'la', 'my', 'mv', 'mn', 'mm', 'np', 'ph', 'sg', 'lk', 'tw', 'tj', 'th', 'tm', 'uz', 'vn'],
        "Australia & Oceania": ["as", "au", "ck", "fj", "fm", "gu", "hm", "ki", "mh", "mp", "nc", "nf", "nr", "nz", "nu", "pf", "pg", "pn", "pw", "sb", "ws", "tv", "to", "vu", "wf"],
        "Central America & Caribbean": ["ag", "bs", "bb", "bz", "cr", "cu", "dm", "do", "sv", "gd", "gt", "ht", "hn", "jm", "ni", "pa", "kn", "lc", "vc", "tt"],
		"Europe": ["al", "ad", "am", "at", "by", "be", "ba", "bg", "hr", "cy", "cz", "dk", "ee", "fi", "fr", "ge", "de", "gr", "hu", "is", "ie", "it", "xk", "lv", "li", "lt", "lu", "mk", "mt", "md", "mc", "me", "nl", "no", "pl", "pt", "ro", "ru", "sm", "rs", "sk", "si", "es", "se", "ch", "ua", "gb", "ie", "va"],
        "MENA": ["af", "dz", "az", "bh", "eg", "ir", "iq", "il", "jo", "kw", "lb", "ly", "ma", "om", "pk", "qa", "sa", "so", "sy", "tn", "tr", "ae", "ye"],    
        "South America": ["ar", "bo", "br", "cl", "co", "ec", "gy", "py", "pe", "sr", "uy", "ve"],
        "Sub-Saharan Africa": ["ao", "bj", "bw", "bf", "bi", "cm", "cv", "cf", "td", "km", "cg", "cd", "ci", "dj", "gq", "er", "et", "ga", "gm", "gh", "gn", "gw", "ke", "ls", "lr", "mg", "mw", "ml", "mr", "mu", "mz", "na", "ne", "ng", "rw", "st", "sn", "sc", "sl", "za", "ss", "sd", "sz", "tz", "tg", "ug", "zm", "zw"],    
    }
    
    function getContinent(iso) {
        for (const continent in continentCodes) {
            var codesList = continentCodes[continent];
            if (codesList.includes(iso)) return continent;
        }
        return "Other";
    }

	var allCountries = $.each(allCodes, function(i, c) {
		c.name = c.n;
		c.iso2 = c.i;
        c.continent = getContinent(c.iso2);
		delete c.n;
		delete c.i;
    });
});